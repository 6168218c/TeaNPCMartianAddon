...
{
    public class SkySearcherBodyAlt : SkySearcherBody
    {
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (base.NPC.life <= 0)
            {
                ...
                Gore.NewGore(base.NPC.position, base.NPC.velocity, ModContent.Find<ModGore>("Gores/Martians/SDminionBodyAltGore").Type, 1f);
            }
        }
        public override bool PreDraw(SpriteBatch spriteBatch,Vector2 screenPos, Color drawColor)
        {
            Texture2D texture2D = Mod.Assets.Request<Texture2D>("TeaNPCAddon/Glow/NPCs/SkySearcherBodyAltGlow").Value;
