...
{
    public class SkyChaser : ModNPC
    {
        public override void SetStaticDefaults()
        {
            //DisplayName.SetDefault("天际追击者");
        ...
        public override void AI()
        {
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient && NPC.localAI[0] >= 90f)
            {
                ...
                if (Collision.CanHit(NPC.position, NPC.width, NPC.height, Main.player[NPC.target].position, Main.player[NPC.target].width, Main.player[NPC.target].height))
                {
                    ...
                    int num7 = Projectile.NewProjectile(NPC.GetProjectileSource(),vector.X, vector.Y, num3 * 13.75f, num4 * 13.75f, type, damage, 0f, Main.myPlayer, 0f, 0f);
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            texture2D = Mod.Assets.Request<Texture2D>("Glow/NPCs/SkyChaserGlow").Value;
